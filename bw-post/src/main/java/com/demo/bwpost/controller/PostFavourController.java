...
import com.demo.bwmodel.dto.postfavour.PostFavourJudgeRequest;
import com.demo.bwmodel.dto.postfavour.PostFavourQueryRequest;
import com.demo.bwmodel.entity.Post;
import com.demo.bwmodel.entity.PostFavour;
import com.demo.bwmodel.entity.User;
import com.demo.bwmodel.rpc.UserServiceRpc;
import com.demo.bwmodel.vo.PostVO;
import com.demo.bwpost.service.PostFavourService;
...
public class PostFavourController {
    ...
    @PostMapping("/judge")
    public BaseResponse<Boolean> judgeFavourOrNot(@RequestBody PostFavourAddRequest postFavourAddRequest,
                                                           HttpServletRequest request) {
        if (postFavourAddRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        User loginUser = userService.getUserByRedis();
        return ResultUtils.success(postFavourService.judgeFavourOrNot(postFavourAddRequest, loginUser.getId()));
    }
